...
стандартными средствами и собственной функцией, реализующей алгоритм сортировки согласно
варианту.

Входные данные: количество элементов, способ ввода входного вектора, вектор (при ручном
вводе).
Выходные данные: отсортированные массивы (стандартными средствами и собственная
реализация), время работы библиотечной и реализованной функций сортировок, ускорение
библиотечной сортировки.

# Особенности:
- должна присутствовать возможность выбора исходного (сортируемого) вектора: вводимый с
  клавиатуры или генерируемый согласно варианту (два возможных для выбора типа
  генерируемых данных; 
- в случае, если число элементов вектора менее некоторого разумного значения, исходный и
  отсортированные двумя методами векторы должны выводиться на экран для сравнения и
...
- в случае, если число элементов вектора более некоторого разумного значения, должны
  ...
  некоторое количество элементов исходного и отсортированных двумя методами векторов.
*/
